...
class CommentController extends Controller
{
    ...
    public function index(Request $request, $id)
    {
        return response()->json([
            ...
            'total' => Comment::where('movie_id', $id)->count()
        ]);
    }
    ...
    public function update(Request $request, Comment $comment)
    {
        ...
        try {
            ...
            Activity::create([
                'user_id' => Auth::user()->id,
                'object_id' => $comment->movie_id,
                'object_type' => Movie::class,
                'description' => 'User #' . Auth::user()->id . ' updated comment #'.$comment->id.' as "' . $request->get('content') . '" in movie #' . $comment->movie_id,
                'content' => $request->get('content'),
                'type' => ActivityType::Comment,
            ]);
    ...
    public function destroy(Request $request)
    {
        ...
        try {
            ...
            Activity::create([
                ...
                'object_id' => $comment->movie_id,
                'object_type' => Movie::class,
                'description' => 'User #' . Auth::user()->id . ' deleted comment #'.$comment->id.' as "' . $request->get('content') . '" in movie #' . $comment->movie_id,
                'type' => ActivityType::Comment,
            ]);
